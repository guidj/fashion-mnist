...
class VGGStrix(base.BaseModel):
    ...
    def __init__(self, num_classes: int, activation: Optional[str], num_blocks: int, block_size: int,
        ...
        vgg19_model = tf.keras.applications.vgg19.VGG19(input_shape=constants.FMNIST_L_DIMENSIONS + (3,),
                                                        include_top=False,
                                                        weights='imagenet')
        vgg19_model.trainable = False

        layers = [feature_layer, i3d_conversion_layer] + vgg19_model.layers[1:]
